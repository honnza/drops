...
if $0 == __FILE__
  ...
  loop do
    ...
    when /^add period (-?\w)(\w)$/
      if $1.to_i(36) == 0 && $2.to_i(36) == 0
        puts "period cannot be zero"
        break
      end
      ruleset.add_period($1.to_i(36), $2.to_i(36))
      puts "ok"
    when /^add period (-?\d+) (-?\d+)$/
      ...
      puts "ok"
    when /^add period (\w)(\w)(\w)(\w)$/
      if $1.to_i(36) == 0 && $2.to_i(36) == 0 || $3.to_i(36) == 0 && $4.to_i(36) == 0
        puts "period cannot be zero"
        break
      end
      ruleset.add_period($1.to_i(36), $2.to_i(36))
      ruleset.add_period($3.to_i(36), -$4.to_i(36))
      puts "ok"
